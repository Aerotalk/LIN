...
function AffiliateDashboardContent() {
    ...
    const sidebarItems = [
        ...
        { name: "Affiliate earnings", icon: <IndianRupee size={20} /> },
    ...
    */
    ...
    const renderEarnings = () => (
        <div className="space-y-10">
            <h2 className="text-[28px] font-bold text-[#EF4444]">Affiliate Earnings</h2>
        ...
        <div className="min-h-screen bg-white pt-40 pb-24 px-4 md:px-12 lg:px-24">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16">
                ...
                <main className="flex-1">
                    ...
                    {activeTab === "Affiliate earnings" && renderEarnings()}
