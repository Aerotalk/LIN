...
export default function FiftyKSalary() {
  return (
    <>
      <PersonalInstaHeroSection
        loanType="Insta"
        loanTitleExtended="for ₹50,000 salary"
        breadcrumb="Loan on ₹50,000 salary"
        loanDesc={
          <>
            If you're earning a salary of Rs. 50,000 and need quick financial
        ...
        <div className="flex flex-col justify-center items-center-safe space-y-12 w-full">
          <div className="flex flex-col justify-center items-center-safe space-y-3 text-center w-full">
            ...
            <h2 className="lg:text-4xl text-3xl font-bold">
              ...
              <span className="text-primary">₹50,000 salary?</span>
            </h2>
